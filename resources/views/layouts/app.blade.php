...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-mini"><b>Store </b> Shop</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Store </b> Shop  </span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url(route('product.index'))}}"><i class="fa fa-product-hunt"></i>Products</a></li>
